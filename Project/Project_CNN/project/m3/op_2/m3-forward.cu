...
// Change: #pragma unroll on the inner dot-product loop (length MATMUL_TILE_WIDTH,
// which is a compile-time constant = 16). This removes loop overhead and exposes
// ILP for the MAC chain.
